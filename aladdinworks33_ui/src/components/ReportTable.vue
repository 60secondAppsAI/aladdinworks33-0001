...
<template>
  ...
  <base-input label="Title" type="text" placeholder="Enter Title" v-model="reportToAdd.title"></base-input>
  <base-input label="GeneratedDate" type="text" placeholder="Enter GeneratedDate" v-model="reportToAdd.generatedDate"></base-input>
                  </form>
                </div>
