...
-->>
				...
				<a-menu-item>
					<router-link to="/maintenanceTasks">
						<span class="label">Maintenance Tasks</span>
					</router-link>
				</a-menu-item>
				...
				<a-menu-item>
					<router-link to="/coolingAlerts">
						<span class="label">Cooling Alerts</span>
					</router-link>
				</a-menu-item>
		
				<a-menu-item>
					<router-link to="/networkAlerts">
						<span class="label">Network Alerts</span>
					</router-link>
				</a-menu-item>
